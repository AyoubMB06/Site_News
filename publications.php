...
session_start();
  ...
  $con = new MongoDB\Client("mongodb://localhost:27017");
    ...
    if(isset($_SESSION["session_login"])){
        ...
        $pubs = $db->avis;
        $pub = $pubs->find( [ 'email' =>$_SESSION['session_login'] ]);
...
<div class="w3-col l8 s12" >  
  ...
  <div class="w3-row">
        ...
        <div class="w3-col m4 w3-hide-small">
            <p align="right"> <a href="delete.php?titre3=<?php echo $pub1['titre']?>"><i class="fa fa-trash" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
        </div> 
  </div>
